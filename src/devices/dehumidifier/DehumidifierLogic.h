...
#ifndef DehumidifierLogic_h
#define DehumidifierLogic_h

#include <stdio.h>
#include "DeviceLogic.h"

class DehumidifierLogic : public DeviceLogic
{
...
private:
     ...
     * 获取功能使能状态
     */
    int getCSFN(int offset);
    
    /**
     * 设置功能使能状态
     */
    void setCSFN(string value, int offset);
...
public:
     ...
     * true为水满
     */
    bool checkWaterFullWarning();
    
    /**
     * 检查水泵
     */
    bool checkWaterPumpError();
