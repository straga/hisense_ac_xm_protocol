...
#ifndef __Service__SensorsFourInOneControl__
#define __Service__SensorsFourInOneControl__

#include "DeviceControl.h"
#include "SensorsFourInOneLogic.h"

class SensorsFourInOneControl : public DeviceControl
{
private:
...
public:
    ...
    SensorsFourInOneControl(string deviceId);
    
    ~SensorsFourInOneControl();
...
#endif /* defined(__Service__SensorsFourInOneControl__) */
